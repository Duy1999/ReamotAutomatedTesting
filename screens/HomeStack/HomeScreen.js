...
import { Text, StyleSheet, FlatList, SafeAreaView, Image, TouchableOpacity, View, Button } from "react-native"
  ...
  render() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        style = {styles.button}
        color = "#DEE8F1"
        ref = {this.props.generateTestHook("Home.editProfile")} 
        title = {""} 
        ...
        style = {styles.button}
        color = "#DEE8F1"
        ref = {this.props.generateTestHook("Home.goToDoctor")}
        title = {""} 
        onPress = {() => this.props.navigation.navigate("DoctorScreen")} />
      </View>
      </SafeAreaView>
    );
  }
