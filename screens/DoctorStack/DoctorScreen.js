...
class DoctorScreen extends Component {
  ...
  renderItem = (item) => {
    ...
    return (
      <TouchableTest
        ref = {this.props.generateTestHook('Doctor')}
  ...
  render() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        {message}
        <TouchableTest 
        ref = {this.props.generateTestHook('DoctorScreen.GiveAccess')}
        style={styles.button} onPress={this.addAccess}>
...
export default hook(DoctorScreen);